...
def evaluating(model, dataloader, criterion, device):
    ...
    return evaluation_loss, map, recall, precision
...
if __name__ == "__main__":    
    try:
        ...
        for epoch in range(config.epochs):
            ...
            evaluation_loss, map, recall, precision = evaluating(model=model, dataloader=val_dataloader, criterion=criterion, device=device)
            print("Val mean loss: {} mAp: {} recall: {} precision: {}".format(evaluation_loss, map, recall, precision))
